/*
 * Adapted from packages/ui/src/components/annotations/annotation-overlay-geometry.ts in Craft Agents OSS v0.13.3 at
 * e8963854c3679edcceb105a42537a06749e6cb64.
 * Copyright 2026 Craft Docs Ltd. Licensed under Apache-2.0.
 * Local changes: use the local AnnotationV1 type and the locally adapted strict resolver.
 */
