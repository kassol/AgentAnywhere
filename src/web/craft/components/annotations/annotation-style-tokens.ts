/*
 * Adapted from packages/ui/src/components/annotations/annotation-style-tokens.ts in Craft Agents OSS v0.13.3 at
 * e8963854c3679edcceb105a42537a06749e6cb64.
 * Copyright 2026 Craft Docs Ltd. Licensed under Apache-2.0.
 * Local changes: none; copied with its original public color and class helpers.
 */
