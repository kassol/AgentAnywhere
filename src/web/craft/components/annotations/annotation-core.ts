/*
 * Adapted from packages/ui/src/components/annotations/annotation-core.ts in Craft Agents OSS v0.13.3 at
 * e8963854c3679edcceb105a42537a06749e6cb64.
 * Copyright 2026 Craft Docs Ltd. Licensed under Apache-2.0.
 * Local changes: use the local structural AnnotationV1 type instead of the Craft runtime package; generate UUIDs required by the Version storage and review contracts.
 */
