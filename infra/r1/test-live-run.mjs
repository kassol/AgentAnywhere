...
console.log(JSON.stringify({ modelId: 'gpt-6-astra', protocol: detail.run.model.protocol, status: detail.run.status, cleanup: detail.run.cleanupState, toolRoundTrip: true, persistedEvents: events.length }))
